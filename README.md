...
O projeto tem o objeto de criar um clone as funções principais do DropBox como um "case" de estudos.

Apesar de não ser um DropBox completo, esse projeto terá seu funcionamento em cloud com o Firebase.
